...
public class Canny extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN,
                WindowManager.LayoutParams.FLAG_FULLSCREEN); //Shows the activity in fullscreen
        ...
        ActivityCompat.requestPermissions(Canny.this,
        ...
        switch (requestCode) {
            case 1: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(Canny.this, "Permission denied to read your External storage", Toast.LENGTH_SHORT).show();
                }
                return;
            }
